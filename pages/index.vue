  ...
  <v-row justify="center" align="center">
    <v-col cols="12" sm="8" md="6">
      ...
      <v-card>
        ...
        <v-card-text>
          <!-- ✅ Display only the logged-in username -->
          <div v-if="$auth.loggedIn" class="mb-4">
            <v-alert type="success" border="left" colored-border elevation="2">
              Logged in as <strong>{{ $auth.user.name || $auth.user.login }}</strong>
            </v-alert>
          </div>
          ...
          <p>
            ...
            <a href="https://chat.vuetifyjs.com/" target="_blank" rel="noopener noreferrer">discord</a>.
          </p>
          <p>
            Find a bug? Report it on the github
            <a href="https://github.com/vuetifyjs/vuetify/issues" target="_blank" rel="noopener noreferrer">issue board</a>.
          </p>
